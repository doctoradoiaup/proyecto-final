...
if 'Volume' in data.columns:
    ...
    # Mostrar la ecuación de la recta en LaTeX con 12 decimales para los coeficientes usando notación científica
    st.latex(r'''
        \text{Close} = %.12f + %.12e \cdot \text{Volume}
        ''' % (beta_0, beta_1))
...
if 'Volume' in data.columns:
    ...
    # Mostrar la ecuación del modelo múltiple en LaTeX con 12 decimales usando notación científica
    st.latex(r'''
        \text{Close} = %.12f + %.12e \cdot \text{Volume} + %.12f \cdot \log(\text{Volume})
